...
Please follow the instructions below to meet the software requirements of the course:
...
PyCharm Professional is free for students. Request a license from 
...
4. Follow these steps to select your Python interpreter in PyCharm:
    ...
    3. Select **Python->Interpreter** from the left menu. The path to where Python is installed should be 
    already displayed in the text box next to Interpreter or in the drop-down menu when you click on the text next to Interpreter. If you do not see this, you need to add the interpreter manually. Click on **Add Interpreter** and then select **Add Local Interpreter...**. From the left menu, select **System Interpreter**. The path to python.exe might already be displayed. If so, click OK; otherwise, click on the button next to the Interpreter text box. Select the folder where Python is installed on your computer. On my computer, it is "C:\Users\ry87\AppData\Local\Programs\Python\Python312\python.exe" 
       (Note that to find this folder, you may need to click on the button 
       **Show Hidden Files and Directories**, which is at the top of the window. 
     Click Ok.
    5. After selecting the interpreter, install the packages we need. Click on the small **+** button on the right.
     Search for **numpy** and select it. At the bottom of the page, select **Install to the user's site packages directory**
